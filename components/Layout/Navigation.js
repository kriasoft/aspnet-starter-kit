  ...
  render() {
    return (
      <nav className="mdl-navigation" ref="root">
        <a id="tt1" className={`mdl-navigation__link ${s.link}`} href="https://github.com/kriasoft/aspnet-starter-kit">
        ...
        <Tooltip for="tt1">Fork us on GitHub</Tooltip>
        <a id="tt2" className={`mdl-navigation__link ${s.link}`} href="https://twitter.com/dotnetreact">
          <svg style={{ width: 36, height: 36 }} viewBox="0 0 24 24">
        ...
        <Tooltip for="tt2">Follow us on Twitter</Tooltip>
      </nav>
    );
  }
